...
export const metadata = {
  title: 'Privacy Policy - VogueVaults',
  description: 'Privacy Policy for VogueVaults - Your premier destination for fashion trends, lifestyle tips, and cultural insights.',
};
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="max-w-4xl mx-auto bg-white dark:bg-neutral-800 rounded-xl shadow-md p-8 mb-12">
        <div className="prose dark:prose-invert max-w-none">
          ...
          <p>
            At VogueVaults, we respect your privacy and are committed to protecting your personal data.
